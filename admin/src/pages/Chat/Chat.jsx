...
const Chat = () => {
  ...
  return (
      <div className="w-full h-screen bg-[#222736] text-white flex flex-col">
        ...
        <div className="flex flex-1 overflow-hidden px-6">
            ...
            <div className="flex-1 py-2 overflow-hidden">
              {activeTab === "Chat" && (
                <>
                  ...
                  <div className="h-[calc(100%)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
              ...
              {activeTab === "Groups" && (
                <>
                  ...
                  <div className="h-[calc(100%-2rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
          ...
          <div className="w-2/3 flex flex-col bg-[#2a3042] rounded-lg ml-4">
              ...
              {selectedChat ? (
                <div className="space-y-4">
                  {selectedChat.messages.map((msg, idx) => (
                    ...
                    >
                      <div
                        className={`text-sm p-3 rounded-lg inline-block max-w-md ${
            ...
            <div className="p-4 border-t border-gray-600">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="flex-1 bg-[#2a3042] outline-none text-white placeholder-gray-400 p-2 rounded-md focus:ring-2 focus:ring-blue-500"
                />
                <button className="bg-blue-500 px-6 py-1 rounded-full hover:bg-blue-600 flex items-center transition-colors">
                  Send
